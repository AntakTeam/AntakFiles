...
if (text and not DevAbs:get(Antak.."Abs:Lock:AutoFile")) then
Time = DevAbs:get(Antak.."Abs:AutoFile:Time")
if Time then 
if Time ~= os.date("%x") then 
local list = DevAbs:smembers(Antak..'Abs:Groups') 
local BotName = (DevAbs:get(Antak.."Abs:NameBot") or 'بروكس')
...
BasicConstructors = DevAbs:smembers(Antak..'Abs:BasicConstructor:'..v)
Constructors = DevAbs:smembers(Antak..'Abs:Constructor:'..v)
